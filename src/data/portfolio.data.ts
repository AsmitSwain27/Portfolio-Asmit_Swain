...
export const portfolioData: PortfolioData = {
  ...
  profileImage: "https://i.ibb.co/yW1pL9g/IMG-20240714-013405.jpg",
  contact: {
  ...
  skills: [
    ...
    { name: "C", level: 70, category: 'Programming Languages' },
    { name: "HTML5", level: 95, category: 'Frontend Development' },
    { name: "CSS3", level: 90, category: 'Frontend Development' },
    { name: "Bootstrap", level: 80, category: 'Frontend Development' },
    { name: "Unity Engine", level: 85, category: 'Game Development' },
    { name: "Blender", level: 75, category: 'Game Development' },
    { name: "Arduino", level: 85, category: 'Hardware' },
    { name: "Machine Learning", level: 65, category: 'Data & AI' },
  ],
};
